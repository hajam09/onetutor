...
class Community(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name='communityLikes')
    dislikes = models.ManyToManyField(User, related_name='communityDislikes')
    ...
    logo = models.ImageField(upload_to='community-logo/', blank=True, null=True,
                             default='community-logo/default-img/default-community-logo.jpg')
    members = models.ManyToManyField(User, related_name='communityMembers')
...
class Forum(models.Model):
    ...
    watchers = models.ManyToManyField(User, blank=True, related_name='forumWatchers')
